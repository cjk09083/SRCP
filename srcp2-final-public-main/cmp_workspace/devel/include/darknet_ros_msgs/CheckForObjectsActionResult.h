...
bool operator==(const ::darknet_ros_msgs::CheckForObjectsActionResult_<ContainerAllocator1> & lhs, const ::darknet_ros_msgs::CheckForObjectsActionResult_<ContainerAllocator2> & rhs)
{
