...
bool operator==(const ::darknet_ros_msgs::CheckForObjectsAction_<ContainerAllocator1> & lhs, const ::darknet_ros_msgs::CheckForObjectsAction_<ContainerAllocator2> & rhs)
{
