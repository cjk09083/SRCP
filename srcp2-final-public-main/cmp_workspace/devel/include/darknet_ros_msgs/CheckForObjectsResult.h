...
bool operator==(const ::darknet_ros_msgs::CheckForObjectsResult_<ContainerAllocator1> & lhs, const ::darknet_ros_msgs::CheckForObjectsResult_<ContainerAllocator2> & rhs)
{
