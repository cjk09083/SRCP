    ...
    try:
        ...
        try:
            ...
            if mode == 'station':
                ...
                cal_h = 1000/h
                #cal_distance1 = 612.57 / (cal_h ^ 1.1)
                cal_distance2 = 2.2613 * cal_h - 0.9453
                print("distance to plant : ", cal_distance2)
                #print("distance to plant : ", cal_distance1, cal_distance2)
                #print("distance to plant : %.2f , $.2f", cal_distance1, cal_distance2)
