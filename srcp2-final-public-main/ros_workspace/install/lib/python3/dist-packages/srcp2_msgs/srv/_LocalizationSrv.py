...
"""autogenerated by genpy from srcp2_msgs/LocalizationSrvRequest.msg. Do not edit."""
import codecs
import sys
...
class LocalizationSrvRequest(genpy.Message):
  _md5sum = "d38b7b718cec41d2541ee881ff979ad0"
  _type = "srcp2_msgs/LocalizationSrvRequest"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.call,) = _get_struct_B().unpack(str[start:end])
      self.call = bool(self.call)
      return self
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from srcp2_msgs/LocalizationSrvResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class LocalizationSrvResponse(genpy.Message):
  ...
  _type = "srcp2_msgs/LocalizationSrvResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class LocalizationSrv(object):
  _type          = 'srcp2_msgs/LocalizationSrv'
  _md5sum = 'c102a4afb0b376754d6cb558ea05ea03'
